...
@Select("select r.latest_content, r.friend_id id,b.avator avatar,b.brand_name title,r.unread from private_rel r left join brand b on r.friend_id=b.customer_id where r.user_id=#{user_id} order by r.modified_at desc")
