...
//     * @return
//     */
//    @GetMapping("/api/v1/ms/sse/push_one/{messsage}/{userid}")
//    public CodeVO pushOne(@PathVariable(name = "message") String message, @PathVariable(name = "userid") String userid) {
//        SseHelper.sendMessage(userid, message);
//        return CodeVO.success("推送消息给" + userid);
//    }
