...
@RestController
public class PodVirtualProductOrderController {

    @Autowired
    private PodVirtualProductOrderService podVirtualProductOrderService;
    ...
    public PodFetchVirtualOrderPageVO fetchVirtualOrders(@Validated PodFetchVirtualOrderPageDTO dto){
        ...
        IPage<PodFetchVirtualOrderPageRO> order = podVirtualProductOrderService.findOrderList(dto);
    ...
    public PodGetVirtualOrderDeliverMaterialVO getVirtualOrderDeliverMaterial(@PathVariable("id") String id){
       ...
       return  podVirtualProductOrderService.findOrderDeliverMaterial(id);
    ...
    public SuccessVO applyRefund(@RequestBody @Validated PodVirtualOrderApplyRefundDTO dto){
        ...
        podVirtualProductOrderService.applyRefund(dto);
