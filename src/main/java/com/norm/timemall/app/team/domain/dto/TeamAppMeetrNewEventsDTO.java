...
import com.norm.timemall.app.base.enums.AppMeetrDurationTypeEnum;
import com.norm.timemall.app.base.enums.AppMeetrEventCategoryEnum;
import com.norm.timemall.app.base.enums.AppMeetrEventTypeEnum;
...
@Data
public class TeamAppMeetrNewEventsDTO {
    private MultipartFile thumbnail;
    @NotBlank(message = "channel required")
    private String channel;

    @NotBlank(message = "eventType required")
    @EnumCheck(enumClass = AppMeetrEventTypeEnum.class,message = "field: eventType, incorrect parameter value")
    ...
    @EnumCheck(enumClass = AppMeetrEventCategoryEnum.class,message = "field: category, incorrect parameter value")
    ...
    @NotBlank(message = "durationType required")
    @EnumCheck(enumClass = AppMeetrDurationTypeEnum.class,message = "field: durationType, incorrect parameter value")
