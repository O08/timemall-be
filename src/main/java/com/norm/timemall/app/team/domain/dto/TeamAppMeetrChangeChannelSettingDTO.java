...
@Data
public class TeamAppMeetrChangeChannelSettingDTO {
    ...
    @EnumCheck(enumClass = SwitchCheckEnum.class,message = "field: postStrategy, incorrect parameter value ,option: on-1; off-0;")
