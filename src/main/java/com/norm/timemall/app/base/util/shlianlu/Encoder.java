...
public class Encoder {
    ...
    public static String generateSignature(final Map<String, Object> data, String key, String signType) throws Exception {
        ...
        for (String k : keyArray) {
            if (k.equals(Constants.FIELD_SIGN) || k.equals("PhoneList") ||  k.equals("phoneSet") || k.equals(Constants.PhoneNumberSet) || k.equals(Constants.TemplateParamSet) || k.equals(Constants.SessionContext) || k.equals(Constants.SessionContextSet) || k.equals(Constants.ContextParamSet)) {
                continue;
            }
